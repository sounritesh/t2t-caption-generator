...
def T5Trainer(dataframe, model_params, device, output_dir="./outputs/"):
  """
  T5 trainer
  ...
  print(f"""[Validation] Generation on Validation data saved @ {os.path.join(output_dir,'predictions.csv')}\n""")